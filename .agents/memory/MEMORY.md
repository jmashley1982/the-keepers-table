...
- [Object storage bucket](object-storage-bucket.md) — Cloudflare R2 via S3 API; all four R2_* env vars required at boot or storage latches into a permanent failed state.
